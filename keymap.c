...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_kbd75_esnahn(
    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   XXXXXXX, MO(_SPECIAL), KC_PSCR,
    ...
    KC_TAB,
              KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  
                                                                                                                                      LT(_CAPS, KC_BSLS),    KC_VOLD,
    LT(_CAPS, KC_LNG1),
              KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,                XXXXXXX,
  ...
  // ),
  // caps lock/tab/backslash key layer
  [_CAPS] = LAYOUT_kbd75_esnahn(
    ...
    _______,  _______,  X(SUP2),  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
    ...
    _______,  _______,  _______,                      X(NBSP),  _______,  X(ZWSP),                      _______,  KC_LNG2,            _______,  _______,  _______
  ),
  // middle key Layer
